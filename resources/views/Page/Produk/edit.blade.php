        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('produk.update', $produk->id) }}" method="POST">
                    ...
                    <div class="form-group with-title mb-3">
                        <textarea class="form-control" name="produk" id="produk" class="form-control"
                            placeholder="Informasi produk seperti detail akun dan lain lain" rows="3" required>{{ $produk->produk }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="idr" id="idr" class="form-control"
                            value="{{ $produk->idr }}" required placeholder="Inputkan nominal tanpa titik atau koma">
                        @error('idr')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
