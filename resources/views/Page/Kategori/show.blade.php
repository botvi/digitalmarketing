            ...
            <table id="example" class="display nowrap">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            @if($category->icon)
                            <img src="{{ asset('/' . $category->icon) }}" alt="{{ $category->nama_kategori }}" width="50" height="50">
                            @endif
                        ...
                        <td>
                            <button onclick="window.location='{{ route('categories.edit', $category->id) }}'" class="btn btn-sm btn-primary"><i class="bi bi-pencil-fill"></i> </button>
